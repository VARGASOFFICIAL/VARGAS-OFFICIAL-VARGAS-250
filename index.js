...
conn.sendMessage(id, 'Owner VARGAS_250 wa.me/+6281227560249' ,MessageType.text);
}
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾VARGAS_250👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/VARGAS_250/' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾VARGAS_250👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/VARGAS_250/' ,MessageType.text);
}
